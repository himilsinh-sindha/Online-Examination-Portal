...
public class UpdateQuestions extends JPanel {
	...
	private void initComponents() {
		...
		header.setText("Update Question");
		...
		update.setFont(new Font("Arial", 1, 22));
		...
		panelShadow1Layout.setHorizontalGroup(panelShadow1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				...
				.addGroup(panelShadow1Layout.createSequentialGroup().addGroup(panelShadow1Layout
						...
						.addGroup(panelShadow1Layout.createSequentialGroup().addGap(218, 218, 218)
								...
								.addGap(124, 124, 124)
								.addComponent(clear, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE))
				...
				.addGroup(GroupLayout.Alignment.TRAILING, panelShadow1Layout.createSequentialGroup()
						...
						.addGroup(panelShadow1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
								.addGroup(panelShadow1Layout.createSequentialGroup().addComponent(opt3)
										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(opt3Field,
												GroupLayout.PREFERRED_SIZE, 773, GroupLayout.PREFERRED_SIZE))
								.addGroup(panelShadow1Layout.createSequentialGroup().addComponent(opt4)
										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(opt4Field,
												GroupLayout.PREFERRED_SIZE, 773, GroupLayout.PREFERRED_SIZE))
								.addGroup(panelShadow1Layout.createSequentialGroup().addComponent(ans)
										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(ansField,
												GroupLayout.PREFERRED_SIZE, 773, GroupLayout.PREFERRED_SIZE))
								.addGroup(panelShadow1Layout.createSequentialGroup().addComponent(que)
										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(queField,
												GroupLayout.PREFERRED_SIZE, 773, GroupLayout.PREFERRED_SIZE))
								...
								.addGroup(panelShadow1Layout.createSequentialGroup().addComponent(qId)
										...
										.addComponent(idField, GroupLayout.PREFERRED_SIZE, 40,
												GroupLayout.PREFERRED_SIZE)
										.addGap(47, 47, 47).addComponent(search)))
						.addGap(96, 96, 96)));
		panelShadow1Layout
				.setVerticalGroup(panelShadow1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addGroup(panelShadow1Layout.createSequentialGroup().addContainerGap().addComponent(header)
								...
								.addGap(14, 14, 14)
								.addGroup(panelShadow1Layout
										.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(qId)
										.addComponent(search).addComponent(idField, GroupLayout.PREFERRED_SIZE,
	...
	private void searchActionPerformed(ActionEvent evt) {
		...
		try {
			...
			if (rs.next()) {
				...
				JFrame jf = new JFrame();
				jf.setAlwaysOnTop(true);
				JOptionPane.showMessageDialog(jf, "Question Doesn't Found!!");
			}
			rs.close();
		} catch (Exception e) {
			JFrame jf = new JFrame();
