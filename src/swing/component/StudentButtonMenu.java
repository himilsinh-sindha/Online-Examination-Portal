...
public class StudentButtonMenu extends JButton {
	...
	public void setIconName(String iconName) {
		...
		setIcon(new ImageIcon(getClass().getResource("/student/icon/" + iconName + ".png")));
	}
	...
	public void setSelected(boolean bln) {
		...
		if (bln) {
			setIcon(new ImageIcon(getClass().getResource("/student/icon/" + iconName + "s.png")));
	...
	private BufferedImage createImage() {
		...
		return new ShadowRenderer(shadowSize, 0.4f, new Color(64, 123, 255)).createShadow(img);
	}
