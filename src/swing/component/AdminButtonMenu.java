...
public class AdminButtonMenu extends JButton {
	...
	public void setIconName(String iconName) {
		...
		setIcon(new ImageIcon(getClass().getResource("/admin/icon/" + iconName + ".png")));
	}
	...
	public void setSelected(boolean bln) {
		...
		if (bln) {
			setIcon(new ImageIcon(getClass().getResource("/admin/icon/" + iconName + "s.png")));
