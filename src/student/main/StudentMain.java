...
import student.component.StudentMenu;
import student.form.StartExam;
import student.form.StudentProfile;
...
public class StudentMain extends JFrame {
	...
	public StudentMain() {
		...
		EventMenu eventMenu = new EventMenu() {
			...
			public void selected(int index) {
				switch (index) {
				case 0:
					showForm(new StudentProfile());
					break;
				case 1:
					showForm(new StartExam());
					break;
				case 2:
	...
	private void initComponents() {
		...
		exit.setIcon(new ImageIcon(getClass().getResource("/student/icon/close.png")));
		...
		panelBackground1Layout.setHorizontalGroup(panelBackground1Layout
				...
				.addGroup(panelBackground1Layout.createSequentialGroup().addContainerGap()
						...
						.addGroup(panelBackground1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
								.addComponent(scroll, GroupLayout.DEFAULT_SIZE, 1098, Short.MAX_VALUE)
