...
public class StudentLogin extends JFrame {
	...
	private void initComponents() {
		...
		header.setMaximumSize(new Dimension(179, 30));
		header.setMinimumSize(new Dimension(179, 30));
		header.setPreferredSize(new Dimension(179, 30));

		jLabel1.setIcon(new ImageIcon(getClass().getResource("/login/image/studentlogin.png")));
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
								.addComponent(header, GroupLayout.PREFERRED_SIZE, 231, GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 747, GroupLayout.PREFERRED_SIZE))
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						...
						.addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 680, GroupLayout.PREFERRED_SIZE)
		...
		userField.setPhColor(new Color(255, 255, 255));
	...
	private void loginActionPerformed(ActionEvent evt) {
		if (userField.getText().equals("student") && Arrays.equals(pwdField.getPassword(),
				new char[] { 's', 't', 'u', 'd', 'e', 'n', 't', '@', '1', '2', '3' })) {
			setVisible(false);
